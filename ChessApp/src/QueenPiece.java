...
public class QueenPiece extends ChessPiece {
	// 1 arg constructor
	public QueenPiece(char side) {
		super(side);
		if (side == 'W')
			this.setImg(new ImageIcon("WhiteQueen.png").getImage());
		else
			this.setImg(new ImageIcon("BlackQueen.png").getImage());
	}
	...
	public boolean moveLegality(int[] pieceNota, int[] moveNota, ChessPiece[][] board) {
		...
		// Checks whether to use diagonal legality or straight move legality
		boolean isDiagonal;
